package cn.mooding.modules.utils;
...
public class DictUtils {
    ...
    {
        Collection<String> keys = SpringUtils.getBean(RedisCache.class).keys(CacheConstant.SYS_DICT_KEY + "*");
    ...
    {
        Collection<String> keys = SpringUtils.getBean(RedisCache.class).keys(CacheConstant.SYS_DICT_KEY + dictType);
        SpringUtils.getBean(RedisCache.class).deleteObject(keys);
    }
}
