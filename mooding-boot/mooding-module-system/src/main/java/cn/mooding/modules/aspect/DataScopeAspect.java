...
import cn.mooding.common.aspect.annotation.DataScope;
...
public class DataScopeAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(cn.mooding.common.aspect.annotation.DataScope)")
        ...
        for (SysRole role : user.getRoles()) {
            ...
            if (DATA_SCOPE_ALL.equals(dataScope)) {
                ...
                sqlString.append(StringUtils.format(
                        " OR {}.dept_id IN ( SELECT dept_id FROM t_sys_role_dept WHERE role_id = {} ) ", deptAlias,
                        role.getRoleId()));
            } else if (DATA_SCOPE_DEPT.equals(dataScope)) {
                sqlString.append(StringUtils.format(" OR {}.dept_id = {} ", deptAlias, user.getDeptId()));
            } else if (DATA_SCOPE_DEPT_AND_CHILD.equals(dataScope)) {
                sqlString.append(StringUtils.format(
                        " OR {}.dept_id IN ( SELECT dept_id FROM t_sys_dept WHERE dept_id = {} or find_in_set( {} , ancestors ) )",
