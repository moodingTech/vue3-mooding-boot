...
public class MyCodeGenerate {
    ...
    public static void  codeGenerate(){
        ...
        //gc.setFileOverride(true);// 默认false 不覆盖源文件，如果要重新生成并覆盖设置true
        mpg.setGlobalConfig(gc);

        // 数据源配置
        DataSourceConfig dsc = new DataSourceConfig();
        dsc.setUrl("jdbc:mysql://49.235.52.198:3306/ry?useUnicode=true&useSSL=false&characterEncoding=utf8");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("wzz107");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        //pc.setModuleName(scanner("模块名"));
        pc.setParent("cn.mooding.modules.monitor");
        /*
       ...
       /* strategy.setInclude(new String[]{"t_sys_dept","t_sys_menu","t_sys_post",
                "t_sys_role","t_sys_role_dept","t_sys_role_menu","t_sys_user_post","t_sys_user_role","t_sys_oper_log","t_sys_logininfo"}); // 需要生成的表*/
        strategy.setInclude(new String[]{"t_sys_job","t_sys_job_log"}); // 需要生成的表
